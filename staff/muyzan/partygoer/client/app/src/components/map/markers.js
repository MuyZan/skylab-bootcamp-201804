...
const electronic = require('./../../static/images/icons/dj.svg')
const concert = require('./../../static/images/icons/rock.svg')
...
const markers ={
    ...
    generic: new mapIcon({iconUrl: concert, iconSize: [48, 85]}),
}
