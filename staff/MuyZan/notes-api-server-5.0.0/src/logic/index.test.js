...
describe("logic (notes)", () => {
  ...
  describe("register user", () => {
    it("should succeed on correct dada", () =>
      logic
        .registerUser("John", "Doe", "jd@mail.com", "123")
        .then(res => expect(res).toBeTruthy()));

    it("should throw error on no name", () =>
      logic
        .registerUser()
    ...
    it("should throw error on no surname", () =>
      logic
        .registerUser("John")
        .catch(({ message }) =>
          expect(message).toBe("surname is not a string")
        ));
    ...
    it("should throw error on blank surname", () =>
      logic
        .registerUser("John", "      ")
        .catch(({ message }) =>
          expect(message).toBe("surname is empty or blank")
    ...
    it("should throw error on empty email", () =>
      logic
        .registerUser("john", "Doe", "")
        .catch(({ message }) =>
          expect(message).toBe("email is empty or blank")
        ));
    it("should throw error on blank email", () =>
      logic
        .registerUser("John", "Doe", "      ")
        .catch(({ message }) =>
          expect(message).toBe("email is empty or blank")
    ...
    it("should throw error on no password", () =>
      logic
        .registerUser("John", "Doe", "jd@mail.com")
        .catch(({ message }) =>
          expect(message).toBe("password is not a string")
        ));
    ...
    it("should throw error on blank password", () =>
      logic
        .registerUser("John", "Doe", "jd@mail.com", "      ")
        .catch(({ message }) =>
          expect(message).toBe("password is empty or blank")
  ...
  describe("authenticate user", () => {
    it("should succeed on correct data", () =>
      User.create({
        ...
        logic
          .authenticateUser("jd@mail.com", "123")
    ...
    it("should throw error on credentials", () =>
      logic
        .authenticateUser("xx@mail.com", "890")
  ...
  describe("retrieve user", () => {
    ...
    it("should throw error on invalid id type", () =>
      logic
        .retrieveUser(true)
        .catch(({ message }) => expect(message).toBe("id is not a string")));
    it("should throw error on empty or blank id", () =>
      logic
        .retrieveUser("")
    ...
    it("should throw error on no user found", () =>
      logic
        .retrieveUser("123456781234567812345678")
        .catch(({ message }) =>
          expect(message).toBe(`no user found with id 123456781234567812345678`)
        ));
  });
  ...
  describe("unregister user", () => {
    it("should succeed on correct data", () =>
      User.create({
        ...
        return logic
          .unregisterUser(id, "jd@mail.com", "123")
          .then(res => {
            expect(res).toBeTruthy();
  ...
  describe("add note", () => {
    it("should succeed on correct data", () =>
      User.create({
        ...
        return logic.addNote(id, "my note").then(noteId => {
          debugger;
    ...
    it("should throw error on wrong user id", () => {
      ...
      return logic
        .addNote(userId, "my note")
        .catch(({ message }) =>
          expect(message).toBe(`no user found with id ${userId}`)
        );
    });
  });
  ...
  false && describe("retrieve note", () => {
    it("should succed on correct data", () => {
      User.create({
        ...
        .then(({ id }) =>{ 
            return User.findByIdAndUpdate(id, { $push: { notes: { text: "hello" } } }, { new: true })
            .then(user => {
            console.log(user)
            return logic.retrieveNote(user.id, user.notes[0].id).then(note => {
            /*  expect(note.id).toBeDefined()
                expect(no.notes.length).toBe(1)
                expect(user.notes.id).toBeDefined()
                expect(user.notes[0].text).toBe('hello') */
            })
          });
        });
    });
      ...
      it("should succed on correct data", () =>{
          return User.create({
            ...
            password: "123"
              ...
              console.log(id)
              return User.findByIdAndUpdate( id, { $push: {notes: {text: 'ding patatas'}}}, {new: true})
